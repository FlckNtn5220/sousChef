...
class ItemsApi(Resource):
    """
    Flask-resftul resource for returning db.items collection.
    :Example:
    >>> from flask import Flask
    >>> from flask_restful import Api
    >>> from app import default_config
    # Create flask app, config, and resftul api, then add ItemsApi route
    >>> app = Flask(__name__)
    ...
    def get(self) -> Response:
        """
        GET response method for all documents in items collection.
...
class ItemApi(Resource):
    ...
    def get(self, item_id: str) -> Response:
        """
        GET response method for single documents in items collection.
        :return: JSON object
        """
